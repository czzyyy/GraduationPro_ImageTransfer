...
from ImageTransfer.fast_real import transfer_net as net
...
if __name__ == '__main__':
    save_path = './stored_models/two/save/transfer_net_two.ckpt'
    evaluate(model_path=save_path, test_image_path='./test/79.jpg', image_save_path='./output/79.png')