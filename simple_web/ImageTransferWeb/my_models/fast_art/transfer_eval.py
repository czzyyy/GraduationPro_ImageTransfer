...
from ImageTransferWeb.my_models.fast_art import transfer_utils as utils
from ImageTransferWeb.my_models.fast_art import transfer_net as net
...
if __name__ == '__main__':
    save_path = './stored_models/eight/save/transfer_net_one.ckpt'
    evaluate(model_path=save_path, test_image_path='./test/chicago.jpg', image_save_path='./output/eightchicago.png')