...
from ImageTransferWeb.my_models.fast_real import transfer_utils as utils
from ImageTransferWeb.my_models.fast_real import transfer_net as net


# get the stored model to generate a transfered image
def evaluate_real(model_path, test_image_path, image_save_path):
...
if __name__ == '__main__':
    save_path = './stored_models/three/save/transfer_net_two.ckpt'
    evaluate_real(model_path=save_path, test_image_path='./test/in40.png', image_save_path='./output/in40.png')